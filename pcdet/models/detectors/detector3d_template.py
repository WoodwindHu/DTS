...
class Detector3DTemplate(nn.Module):
    ...
    ## for mean teacher
    def get_graph_loss(self, batch_target1, batch_target2, reweight=True): 
        '''
        batch_target1:
            'rois_mt': roi,
        ...
        for index in range(batch_size): 
            ...
            roi_head_features_a = batch_target1['roi_head_features'][index,:,:]
            pred_box_b = batch_target2['rois_mt'][index,:,:7]
            cls_scores_b = batch_target2['roi_scores_mt'][index] 
            roi_head_features_b = batch_target2['roi_head_features'][index,:,:]
            ...
            iou_mask = (ious >= self.model_cfg.get('INTER_GRAPH_THRESHOLD', 0.7)) #筛选s&t的ground truth box的iou足够大的region
